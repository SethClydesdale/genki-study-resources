...
Genki.jisho = {
  ...
  'あ' : [
    ...
    { ja : '頭が悪い|あたまがわるい', en : 'slow; weak-headed; dumb', l : 'ワークブックL13-P15' },
    ...
    { ja : 'アフリカ', en : 'Africa', l : 'ワークブックL13-P16' },
    ...
    { ja : '安心|あんしん', en : 'relief', l : '読L13-漢字表' },
  ...
  'い' : [
    ...
    { ja : '生け花|いけばな', en : 'flower arrangement', l : '読L19-漢字表' },
  ...
  'う' : [
    ...
    { ja : '馬|うま', en : 'horse', l : 'ワークブックL13-P16' },
  ...
  'お' : [
    ...
    { ja : '王子|おうじ', en : 'prince', l : 'ワークブックL19-P65' },
    ...
    { ja : '大阪|おおさか', en : 'Osaka', l : 'ワークブックL7-P69' },
    ...
    { ja : 'おから', en : 'Okara (food); soy pulp; tofu dregs', l : 'ワークブックL20-P74' },
    ...
    { ja : 'オペラ歌手|オペラかしゅ', en : 'opera singer', l : 'ワークブックL22-P92' },
  ...
  'か' : [
    ...
    { ja : 'カード', en : 'card', l : 'ワークブックL23-P104' },
    { ja : 'ガイド', en : 'guide; tour guide', l : 'ワークブックL20-P75' },
    ...
    { ja : '顔色|かおいろ', en : 'compelxion', l : '読L23-漢字表' },
    ...
    { ja : '学費|がくひ', en : 'tuition; school expenses', l : 'ワークブックL10-P97' },
    ...
    { ja : 'カスタマーサービス', en : 'customer service', l : 'ワークブックL18-P57' },
    ...
    { ja : 'かっこ悪い|かっこわるい', en : 'unattractive; ugly; unstylish; uncool', l : 'ワークブックL22-P89' },
    { ja : '学校|がっこう', en : 'school', l : '会L3' },
    { ja : 'カット', en : 'cut', l : '会L17(e)' },
    { ja : 'カップラーメン', en : 'cup noodles; cup ramen', l : 'ワークブックL18-P57' },
  ...
  'き' : [
    ...
    { ja : '帰国|きこく', en : 'going home', l : '読L7-漢字表' },
  ...
  'く' : [
    ...
    { ja : 'クッキー', en : 'cookie', l : 'ワークブックL18-P57' },
  ...
  'け' : [
    ...
    { ja : '原因|げんいん', en : 'cause; origin; source', l : 'ワークブックL18-P57' },
  ...
  'さ' : [
    ...
    { ja : '刺身|さしみ', en : 'raw fish', l : 'ワークブックL12-P112' },
  ...
  'し' : [
    ...
    { ja : '司会|しかい', en : 'chairman; host; master of ceremonies', l : 'ワークブックL19-P60' },
    ...
    { ja : '自身|じしん', en : 'confidence', l : '読L21-漢字表' },
    { ja : '静岡|しずおか', en : 'Shizuoka (city)', l : 'ワークブックL19-P65' },
    ...
    { ja : '指名|しめい', en : 'full name', l : '読L9-漢字表' },
    ...
    { ja : 'ジョギング', en : 'jogging', l : 'ワークブックL23-P104' },
  ...
  'す' : [
    ...
    { ja : 'スイス', en : 'Switzerland', l : 'ワークブックL13-P19' },
    ...
    { ja : 'スクリーン', en : 'screen', l : 'ワークブックL18-P57' },
    { ja : 'スケジュール', en : 'schedule', l : 'ワークブックL3-P33' },
    ...
    { ja : 'ステーク', en : 'steak', l : '読L2-I' },
    { ja : 'ストックホルム', en : 'Stockholm (Sweden)', l : '読L2-I' },
  ...
  'と' : [
    ...
    { ja : 'とうふ', en : 'tofu', l : 'ワークブックL20-P75' },
    ...
    { ja : 'ドレス', en : 'dress', l : 'ワークブックL7-P71' },
  ...
  'な' : [
    ...
    { ja : '内科|ないか', en : 'physician; internal medicine', l : '会L12(e), 読L22-漢字表' },
    ...
    { ja : '名古屋|なごや', en : 'Nagoya', l : 'ワークブックL7-P72' },
  ...
  'ね' : [
    ...
    { ja : '熱を測る|ねつをはかる', en : "to check someone's temperature", v : 'u', l : 'ワークブックL12-P112' },
  ...
  'は' : [
    ...
    { ja : 'バンコク', en : 'Bangkok (Thailand)', l : 'ワークブックL12-P112' },
  ...
  'ひ' : [
    ...
    { ja : 'ビーチ', en : 'beach', l : 'ワークブックL11-P104' },
    { ja : 'ピーマン', en : 'bell pepper; green pepper', l : 'ワークブックL13-P13' },
    ...
    { ja : 'ピクニック', en : 'picnic', l : 'ワークブックL6-P62' },
    ...
    { ja : 'ピラミッド', en : 'pyramid', l : 'ワークブックL13-P16' },
  ...
  'ふ' : [
    ...
    { ja : '拭く|ふく', en : 'to wipe; to dry', v : 'u', l : 'ワークブックL23-P104' },
  ...
  'ほ' : [
    ...
    { ja : 'ほうれん草|ほうれんそう', en : 'spinach', l : 'ワークブックL13-P20' },
    { ja : 'ボーイフレンド', en : 'boyfriend; male friend', l : 'ワークブックL7-P71' },
  ...
  'み' : [
    ...
    { ja : 'ミュージカル', en : 'musical', l : 'ワークブックL11-P104' },
  ...
  'も' : [
    ...
    { ja : 'モスクワ', en : 'Moscow (Russia)', l : 'ワークブックL12-P112' },
    ...
    { ja : 'モンゴル', en : 'Mongolia', l : 'ワークブックL13-P16' },
  ...
  'よ' : [
    ...
    { ja : '読み物|よみもの', en : 'reading matter', l : '読L8-漢字表' },
  ...
  'ら' : [
    ...
    { ja : 'ライト', en : 'light', l : 'ワークブックL18-P57' },
  ...
  'ろ' : [
    ...
    { ja : '六甲山|ろっこうさん', en : 'Mt. Rokko', l : 'ワークブックL17-P49' },
